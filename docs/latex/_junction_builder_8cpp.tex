...
, \mbox{\hyperlink{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24ceca945d6010d321d9fe75cbba7b6f37f3b5}{CUSTOM}}
 \}
...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{_junction_builder_8cpp_a424e65499f869afefcf6e67fc93244e0}{\+\_\+draw\+Junction\+Box}} (std\+::string filename, std\+::string selected\+Tag, \mbox{\hyperlink{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24cec}{Box\+Size}} selected\+Size, Ac\+Ge\+Point3d origin)
\begin{DoxyCompactList}\small\item\em Draw a junction box from a file. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{_junction_builder_8cpp_aa844a2516b648fbe44e436b1bb22699c}{\+\_\+should\+Split}} (\mbox{\hyperlink{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24cec}{Box\+Size}} box\+Size, std\+::vector$<$ \mbox{\hyperlink{class_cable}{Cable}} $>$ \&cables, int current\+Cable\+Index, int current\+Terminal\+Index, int current\+Table\+Index)
\begin{DoxyCompactList}\small\item\em Given a cable list and a current position in that list, should the next cable be drawn on the next table. \end{DoxyCompactList}\item 
...
int \mbox{\hyperlink{_junction_builder_8cpp_ae24a2202757a9ad485ef33f4414d233a}{\+\_\+xlsx\+Get\+Junction\+Footprint}} (HWND h\+Dlg, std\+::string filename, std\+::string junction\+Tag, \mbox{\hyperlink{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24cec}{Box\+Size}} box\+Size)
...
void \mbox{\hyperlink{_junction_builder_8cpp_a61eeca46bd44d805104d6ef446cf0ed1}{flip\+Cable}} ()
\begin{DoxyCompactList}\small\item\em Flip a cable or a set of cables. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{_junction_builder_8cpp_ade6915c93cdde099130ea33c6baa3914}{re\+Index\+Cable}} ()
...
\raisebox{\heightof{T}}[0pt][0pt]{\index{CUSTOM@{CUSTOM}!JunctionBuilder.cpp@{JunctionBuilder.cpp}}\index{JunctionBuilder.cpp@{JunctionBuilder.cpp}!CUSTOM@{CUSTOM}}}\Hypertarget{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24ceca945d6010d321d9fe75cbba7b6f37f3b5}\label{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24ceca945d6010d321d9fe75cbba7b6f37f3b5} 
...
\end{DoxyReturn}
\Hypertarget{_junction_builder_8cpp_a424e65499f869afefcf6e67fc93244e0}\index{JunctionBuilder.cpp@{JunctionBuilder.cpp}!\_drawJunctionBox@{\_drawJunctionBox}}
\index{\_drawJunctionBox@{\_drawJunctionBox}!JunctionBuilder.cpp@{JunctionBuilder.cpp}}
\doxysubsubsection{\texorpdfstring{\_drawJunctionBox()}{\_drawJunctionBox()}}
{\footnotesize\ttfamily \label{_junction_builder_8cpp_a424e65499f869afefcf6e67fc93244e0} 
void \+\_\+draw\+Junction\+Box (\begin{DoxyParamCaption}\item[{std\+::string}]{filename}{, }\item[{std\+::string}]{selected\+Tag}{, }\item[{\mbox{\hyperlink{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24cec}{Box\+Size}}}]{selected\+Size}{, }\item[{Ac\+Ge\+Point3d}]{origin}{}\end{DoxyParamCaption})}
...
\hline
{\em selected\+Tag} & Tag (e.\+g. "{}\+IJB-\/810"{}) identifying the junction whose cables should be extracted. \\
\hline
{\em selected\+Size} & Size of the box to be drawn. \\
\hline
{\em origin} & Point where the box should be drawn. (Usually 0 0 0) \\
\hline
\end{DoxyParams}
...
\hline
\end{DoxyParams}
\Hypertarget{_junction_builder_8cpp_aa844a2516b648fbe44e436b1bb22699c}\index{JunctionBuilder.cpp@{JunctionBuilder.cpp}!\_shouldSplit@{\_shouldSplit}}
\index{\_shouldSplit@{\_shouldSplit}!JunctionBuilder.cpp@{JunctionBuilder.cpp}}
\doxysubsubsection{\texorpdfstring{\_shouldSplit()}{\_shouldSplit()}}
{\footnotesize\ttfamily \label{_junction_builder_8cpp_aa844a2516b648fbe44e436b1bb22699c} 
bool \+\_\+should\+Split (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24cec}{Box\+Size}}}]{box\+Size}{, }\item[{std\+::vector$<$ \mbox{\hyperlink{class_cable}{Cable}} $>$ \&}]{cables}{, }\item[{int}]{current\+Cable\+Index}{, }\item[{int}]{current\+Terminal\+Index}{, }\item[{int}]{current\+Table\+Index}{}\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em box\+Size} & Size of the box. \\
\hline
{\em cables} & Reference to a vector of {\ttfamily \doxylink{class_cable}{Cable}} objects. \\
\hline
{\em current\+Cable\+Index} & The index of the cable that is about to be added to the drawing. \\
\hline
{\em current\+Terminal\+Index} & The terminal that the next cable will reside on. \\
\hline
{\em current\+Table\+Index} & The current table being drawn to. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
{\ttfamily true} if the cable being drawn should be placed on the next table, {\ttfamily false} otherwise. 
\end{DoxyReturn}
...
\end{DoxyReturn}
\Hypertarget{_junction_builder_8cpp_ae24a2202757a9ad485ef33f4414d233a}\index{JunctionBuilder.cpp@{JunctionBuilder.cpp}!\_xlsxGetJunctionFootprint@{\_xlsxGetJunctionFootprint}}
...
{\footnotesize\ttfamily \label{_junction_builder_8cpp_ae24a2202757a9ad485ef33f4414d233a} 
int \+\_\+xlsx\+Get\+Junction\+Footprint (\begin{DoxyParamCaption}\item[{HWND}]{h\+Dlg}{, }\item[{std\+::string}]{filename}{, }\item[{std\+::string}]{junction\+Tag}{, }\item[{\mbox{\hyperlink{_junction_builder_8cpp_aaf39cd3357b27aad8818297c73a24cec}{Box\+Size}}}]{box\+Size}{}\end{DoxyParamCaption})}
...
\hline
{\em box\+Size} & Size of the box to calculate the footprint on. (Required to account for table splitting) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
The process may include reading from an Excel file to gather necessary input data, interacting with Auto\+CAD for drawing purposes, and managing various attributes related to devices and cables. It serves as a core functionality of the Junction Diagram Automation Suite. \Hypertarget{_junction_builder_8cpp_a61eeca46bd44d805104d6ef446cf0ed1}\index{JunctionBuilder.cpp@{JunctionBuilder.cpp}!flipCable@{flipCable}}
\index{flipCable@{flipCable}!JunctionBuilder.cpp@{JunctionBuilder.cpp}}
\doxysubsubsection{\texorpdfstring{flipCable()}{flipCable()}}
{\footnotesize\ttfamily \label{_junction_builder_8cpp_a61eeca46bd44d805104d6ef446cf0ed1} 
...
This function asks the user to select a set of cable-\/related blocks, and then automatically flips the cables about the axis of the junction termination block \Hypertarget{_junction_builder_8cpp_ade6915c93cdde099130ea33c6baa3914}\index{JunctionBuilder.cpp@{JunctionBuilder.cpp}!reIndexCable@{reIndexCable}}
\index{reIndexCable@{reIndexCable}!JunctionBuilder.cpp@{JunctionBuilder.cpp}}
\doxysubsubsection{\texorpdfstring{reIndexCable()}{reIndexCable()}}
{\footnotesize\ttfamily \label{_junction_builder_8cpp_ade6915c93cdde099130ea33c6baa3914} 
